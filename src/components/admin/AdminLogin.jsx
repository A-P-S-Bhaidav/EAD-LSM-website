...
export default function AdminLogin({ onLogin }) {
  ...
  const handleSubmit = () => {
    if (
      ...
      ead.toLowerCase() === 'delhi'
    ) {
      onLogin({ name, email, ead });
      setError(false);
    } else {
      setError(true);
    }
  ...
  return (
    <div className="bg-white p-10 rounded-xl shadow-[0_4px_12px_rgba(0,0,0,0.05)] max-w-[400px] my-20 mx-auto font-inter">
      <h1 className="text-center mb-8 text-2xl font-bold text-[#333]">Admin Login</h1>
      <div className="mb-5">
      ...
      <div className="mb-5">
        <label className={labelClass}>EAD Location</label>
        <input 
          type="text" 
